...
def  cal_final_price(df_final):
            ...
            for i in range(len(df_final)):
                ...
                df_final['final_price($/oz)'][i] = round((pr_indoll/unit_inoz),4) 
...
def sorted_bestprice(df_best_price):
            ...
            '''
            Retruns sorted price list of the searched item.
            '''
...
def django_input(itemname, zipcode):
       ...
       # dataframe with selected columns only from output dictionary               
        ...
        # clean, convert and update on ext_weight(oz) column and drop if 
        # emtpy becasue we need unit to compare price
        ...
        # Clean, extract and update ext_price column and return
        ...
        final_list = sorted_bestprice(df_best_price)
